...
To gain root access, one must follow the steps on \hyperref{http://wiki.samygo.tv/index.php5/Rooting_D_series_arm_cpu_models}.
...
With this the TV will be rooted.

To cross-compile code for the Samsung TV, 
a cross-compilation toolchain is needed, which can be found \hyperref{here\ref*{https://opensource.samsung.com}}.
With this, we can cross-compile libswift for the TV.

Further development will then involve the use of the Samsung SDK with another daemon that handles the libswift calls.
